...
public class TelaLoginProprietario extends javax.swing.JFrame {
        ...
        private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(TelaLoginProprietario.class.getName());
    ...
    String sql = "select * from t_aah_proprietario where nm_proprietario = ? and ds_senha = ? ";
    
    try {
        // Agora sim! Garantido que "conexao" não é null
