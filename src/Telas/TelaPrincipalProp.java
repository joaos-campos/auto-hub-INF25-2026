...
public class TelaPrincipalProp extends javax.swing.JFrame {
    ...
    /**
     * Creates new form TelaPrincipalProp
     * @param nmUsuario
     */
    public TelaPrincipalProp(String nmUsuario){
        initComponents();
        this.lblNomeUsuario.setText(nmUsuario);
        this.lblNomeUsuario.setForeground(Color.BLUE);
    }
