...
public class TelaLoginPrestador extends javax.swing.JFrame {
    ...
    {
        String sql = "select * from t_aah_prestador where ds_nome_usuario  = ? and ds_senha = ? COLLATE utf8mb4_bin";
        ...
        try 
        {
            ...
            { 
                ...
                JOptionPane.showMessageDialog(this, "Usuário e/ou Senha INVÁLIDOS! Verifique os campos e tente novamente!");               
                TxtUsuarioPresta.requestFocus();
            }
